...
//! only wanted to know what to send has it in the first line; one who wondered why
//! it was not the page that links everything reads on and finds that question
//! answered by name.
...
mod tests {
    ...
    use lemonfiber_core::door::Facing;
