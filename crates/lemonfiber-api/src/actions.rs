...
pub use asked::{
    ...
    TAKES_BUNDLING, TAKES_CHECK, TAKES_CONSENT, TAKES_DISRUPTION, TAKES_FORMS, TAKES_ITEM,
    TAKES_NAME, TAKES_NARROWING, TAKES_PRESET, TAKES_SERVICE, TAKES_SERVICES, TAKES_SETTING,
    TAKES_TERM, TAKES_WAITING,
};
