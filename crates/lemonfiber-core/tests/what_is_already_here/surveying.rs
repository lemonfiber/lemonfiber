//! Looking at what is already on the machine.

use crate::common::stack::project;
use crate::{ctx, driven, facts, mounting, over, over_files, somebody_elses, standing};
...
use lemonfiber_fixtures::support::{refused, spoke, Recording, Reporting, SeedFs};
use std::path::Path;
use std::sync::Arc;
