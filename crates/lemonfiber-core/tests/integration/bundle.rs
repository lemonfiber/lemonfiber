...
use lemonfiber_core::error::codes::bundle::NOWHERE_TO_KEEP;
use lemonfiber_core::error::codes::bundle::{
...
fn asking(vault: &Arc<Recorder>) -> Ctx {
    ctx(Source::External(project()), false, None).with_archives(Archiving {
