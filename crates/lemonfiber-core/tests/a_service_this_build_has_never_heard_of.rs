...
fn ctx(up: &[&str]) -> Ctx {
    Ctx::new(
        ...
        lemonfiber_ports::seams::Seams {
            ...
            // Named rather than left live: a start asks what else on this machine
            // holds the ports it wants, and a test that let that question reach a
            // real daemon would answer differently on every machine it ran on.
