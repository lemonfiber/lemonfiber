...
Of the forty requests, thirty-seven reach the web in full, two reach it in
part, zero do not reach it at all, and one — `ui` — is an honest exception. Two gaps
...
On the other side of the table thirty-five reach the terminal in full, four reach
