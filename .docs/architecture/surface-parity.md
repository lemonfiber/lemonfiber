...
Of the thirty-three requests, thirty-two reach the web in full, zero reach it in
...
On the other side of the table thirty-two reach the terminal in full, zero reach
