...
Of the thirty-two requests, thirty-one reach the web in full, zero reach it in
...
On the other side of the table thirty-one reach the terminal in full, zero reach
