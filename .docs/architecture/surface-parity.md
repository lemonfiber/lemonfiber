...
On the other side of the table thirty-nine reach the terminal in full, four reach
...
line accepts is reachable from a screen, and all but five of them are reachable
whole.
