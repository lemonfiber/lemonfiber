...
On the other side of the table seventeen reach the terminal in full, nine reach
...
Nine rows read that way, and with the web column finished they are the whole of
