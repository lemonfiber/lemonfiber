...
Of the twenty-eight requests, twenty-seven reach the web in full, zero reach it in
...
On the other side of the table twenty-seven reach the terminal in full, zero reach
