...
Of the thirty-nine requests, thirty-six reach the web in full, two reach it in
...
On the other side of the table thirty-five reach the terminal in full, three reach
...
line accepts is reachable from a screen, and all but two of them are reachable
whole.
