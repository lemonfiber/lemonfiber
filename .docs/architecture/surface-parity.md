...
Of the thirty-four requests, thirty-three reach the web in full, zero reach it in
...
On the other side of the table thirty-three reach the terminal in full, zero reach
