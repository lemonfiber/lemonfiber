...
Of the thirty requests, twenty-nine reach the web in full, zero reach it in
...
On the other side of the table twenty-nine reach the terminal in full, zero reach
