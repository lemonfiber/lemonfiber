...
offered none of its three writes, and reads the same now that it offers all three,
because the media type a choice applies to is left to a browser. What changed is in
